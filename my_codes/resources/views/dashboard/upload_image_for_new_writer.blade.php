...
@section('title')
افزودن تصویر برای نویسنده: {{ $writer->name }}
@endsection
@section('content')
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">افزودن تصویر برای نویسنده</h1><br>
                <div class="card mb-4">
                    ...
                    <div class="card-body" style="direction: rtl;">
                        <form action="{{ route('upload.writer.image.post', ['writer' => $writer->id]) }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="mb-3">
