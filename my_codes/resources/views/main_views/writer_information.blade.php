...
@section('content')
	...
	@elseif(auth()->check() && $writer->is_follower(auth()->user()->id))
		<br>
	...
	@elseif(!(auth()->check()))
		<br>
		<a href="#" class="btn btn-primary disabled" style="margin-right: 10px;">دنبال کردن</a>
		<span class="text-danger">برای دنبال کردن این نویسنده، ابتدا باید وارد شوید.</span>
	@endif
	<br><br>
