...
Route::get('/edit-comment/{comment}', 'CommonPagesController@edit_comment')->name('edit.comment');

Route::put('/update-comment/{comment}', 'CommonPagesController@update_comment')->name('update.comment');
